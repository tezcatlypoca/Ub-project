...
En utilisant l'algorithme d'Euclide étendu, calculez le pgcd de 144 et 233 ainsi que les coefficients de Bezout.
Utilisez la représentation habituelle en tableau.
...
6. Un programme est en $O(n^2)$. Il met 1 secondes pour $n=1000$. 
...
En supposant que le programme est en $O(n^d)$, donnez la relation entre
...
10.  E. Quelle est la complexité du tri naïf~?

11. Un tableau de $n$ valeurs entières (toutes différentes)~:  V[1], V[2], .... V[n] est donné.
...
dans le tableau  V[1], V[2], .... V[k]~; cette dernière peut utiliser V[k]~; elle peut aussi ne pas l'utiliser. 
Voici un exemple possible~:
$$\begin{array}{|c|cccccccc|}
\hline
i & 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8 \\
V & 10 & 4 & 5 & 20 & 6 & 8 & 30 & 9 \\
M & 1 & 1 & 2 & 3 & 3 & 4 & 5 & 5 \\
\hline
\end{array}
$$
