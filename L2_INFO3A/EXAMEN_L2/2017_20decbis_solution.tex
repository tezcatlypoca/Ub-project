...
Vous remplirez les cases, ou une partie des cases, du tableau~: $U(p,i)$, pour $i=0$ à 3, et $p=1$ à 5. $U(p,i)$ est la plus grand utilité des sac à dos utilisant les articles dans $\{1, \ldots i\}$ et de poids inférieur ou égal à $p$. 
%Il faut calculer $U(p=5, i=3)$.
%Rappel~: $U(p, 0)$ vaut $0$ si $u_0>p$ et $u_0$ sinon~;
% $U(p, i>0)$ vaut $U(p, i-1)$ si $p_i>p$ et $\max( U(p, i-1), u_i+ U(p-p_i, i-1))$ sinon.
\begin{center}\begin{tabular}{|c|c|c|c|c|}\hline
U(p,i) &       i=1 &     i=2 &     i=3 &     i=4\\\hline
p=1 & 0 & 10 & 10 & 10 \\\hline
p=2 & 12 & 12 & 12 & 15 \\\hline
p=3 & 12  & 22 & 22 & 25 \\\hline
p=4 & 12 & 22 & 30 & 30 \\\hline
p=5 & 12 & 22 & 32 & 37 \\\hline
\end{tabular}\end{center}
