...
3. Le graphe $G$ est ci-dessous. Dessinez son graphe réduit, $R$. Indiquez sur chaque sommet de $R$ quels sont les sommets correspondant dans $G$.
\begin{center}
...
\end{center}
\ifcorrige {\it Solution. La longueur du chemin le plus court est $\min_k G_{ak}+G_{kc}$. }
\else\fi
